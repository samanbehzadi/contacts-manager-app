...
export default function CourseInfo() {
    ...
    //     fetch(`http://localhost:4000/v1/courses/npm`, {
    //         method: 'POST',
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:4000/v1/courses/${courseName}`, {
            ...
            .then((res) => res.json())
            .then((courseInfo) => {
                setComments(courseInfo.comments ? courseInfo.comments : []);
                    ...
                    <div className="row">
                        <div className="col-6">
                            <a href="#" className="course-info__link">
                                {courseDetails.categoryID === undefined ? null : courseDetails.categoryID.title}
                            </a>
                                ...
                                <div className="course-boxes">
                                    <div className="row">
                                        ...
                                        <CourseDetailBox
                                            icon="clock"
                                            title="زمان برگزاری"
                                            text={createdAt !== undefined ? createdAt.slice(0, 10) : '2020/04/15'}
                                        />
                                        <CourseDetailBox
                                            icon="calendar-alt"
                                            title="آخرین بروزرسانی"
                                            text={updatedAt !== undefined ? updatedAt.slice(0, 10) : '2020/04/15'}
                                        />
                                    </div>
                                </div>
                                    ...
                                    <div className="introduction__topic">
                                        <Accordion defaultActiveKey="0">
                                            <Accordion.Item eventKey="0" className="accordion">
                                                ...
                                                {sessions !== undefined && sessions.map((session, index) => (
                                                    <Accordion.Body key={session._id} className="introduction__accordion-body">

                                                        {/* to check if user has permission to watch this video or Not */}
                                        ...
                                        <div className="techer-details__header-right">
                                            ...
                                            <div className="techer-details__header-titles">
                                                <a href="#" className="techer-details__header-link">
                                                    محمدامین سعیدی راد
                                                    {/* {
                                                        courseTeacher.name !== undefined ? courseTeacher.name : 'محمد‌امین سعیدی راد'
                                                    } */}
                                                </a>
